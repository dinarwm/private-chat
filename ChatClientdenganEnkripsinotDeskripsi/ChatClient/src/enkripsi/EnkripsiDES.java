...
public class EnkripsiDES {
    ...
    public static String Enkripsi(String teks, String id) throws UnsupportedEncodingException{
        EnkripsiDES.id = id;
        EnkripsiDES.Pesan = teks;
        System.out.println(EnkripsiDES.id);
        System.out.println(EnkripsiDES.Pesan);
        ...
        PesanHex = toHex(EnkripsiDES.Pesan); //dadi hexa
        //System.out.println("panjang " + first_name);
        
        int itung;
        itung = PesanHex.length()/2;
        itung = itung%8;
        itung = 8-itung;
        for(int a=0;a<itung;a++){
            PesanHex = PesanHex + "00";
        }
        //System.out.println("Hexa " + first_name);
        
        byte[] bytes = DatatypeConverter.parseHexBinary(PesanHex);
        String result= new String(bytes,"UTF-8");
        System.out.println("lalala");
        test(
            parseBytes(PesanHex),
            parseBytes(EnkripsiDES.id)
        );
        System.out.println(EnkripsiDES.enkripsi);
        return EnkripsiDES.enkripsi;
    ...
    public static boolean test(byte[] message, byte[] key) {
        ...
        EnkripsiDES.enkripsi=hex(received);
